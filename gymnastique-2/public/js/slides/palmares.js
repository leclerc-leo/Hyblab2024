        ...
        promise.then(()=>{
            ...
            if(card != card_container){
                ...
                if(card_container.children[1].classList.contains("flipcard")){
                    ...
                    if(card.id==="card-mondiaux" || card.id==="card-inter"){
                        card_container.id==="card-afrique" || card_container.id==="card-inter" ?
                        card.style.transform = "translate(0px,10vh)" :
                            card.style.transform = "translate(0,0)";
                    }
                    /*
                    if(card.id==="card-inter"){
                        if(card_container.id==="card-afrique") {
                            card.style.transform = "translate(0,15vh) scale(1,0.5)"
                        }else{
                            card.style.transform = "translate(0,0) scale(1,0.5)";
                        }
                    }*/
